...
class Users4{
   ...
   private String key_Name;
    ...
    private int Count;
    private int Summed;
    public Users4(String building_name,String key_name,String emp_name, int count, int summed){
...
public class keys_returned extends javax.swing.JFrame {
 ...
 // create a function to fill the an arraylist from database
    ...
    static ArrayList<Users4> getUsers4(){
        
        ArrayList<Users4> users4 = new ArrayList<Users4>();
        ...
        try {
            ...
            rs = st.executeQuery("SELECT count(tbl_keysreturned.key_details) as counted, sum(tbl_keysreturned.keys_returned) as summed,tbl_keys.building_name, tbl_keys.key_name, tbl_employee.emp_name\n" +
...
"INNER JOIN tbl_keys ON tbl_keysreturned.key_Details=tbl_keys.key_id INNER JOIN tbl_employee ON tbl_keysreturned.emp_details=tbl_employee.e_id group by tbl_keysreturned.key_details, tbl_employee.emp_name, tbl_keys.key_name;");
    ...
    private void initComponents() {
        ...
        jtbl_keys_returned = new javax.swing.JTable();
        btn_export2excel = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("مفاتيح التقارير التي تم إرجاعها");
        ...
        jtbl_keys_returned.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "الرقم التسلسلي", "اسم المبنى", "اسم المفتاح", "اسم الموظف", "عدد المشكلات", "عدد المفاتيح"
            }
        ) {
        ...
        jScrollPane3.setViewportView(jtbl_keys_returned);
    ...
    private void cmd_printActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmd_printActionPerformed
        ...
        try
        {
         ...
         // jtbl_keys_remaining.setFont(new Font("Courier", Font.BOLD, 12));
          ...
          jtbl_keys_returned.print(JTable.PrintMode.FIT_WIDTH, headerFormat, footerFormat);
        }
    ...
    private void btn_export2excelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_export2excelActionPerformed
        ...
        exportTable(jtbl_keys_returned, new File("C:\\Users\\"+ username +"\\Desktop\\keysreturned.xls"));
        } catch (IOException ex) {
            Logger.getLogger(keys_returned.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    {
         DefaultTableModel model = (DefaultTableModel)jtbl_keys_returned.getModel();
        
    // AbstractTableModel model = (AbstractTableModel)jtbl_keys_remaining.getModel();
        
        Object[] rowData = new Object[8];
        
        for(int i = 0; i < getUsers4().size(); i++){
            
            rowData[0]  =   i+1;
            rowData[1] = getUsers4().get(i).getbuilding_Name();
             rowData[2] = getUsers4().get(i).getkey_Name();
              rowData[3] = getUsers4().get(i).getemp_Name();
               rowData[4] = getUsers4().get(i).getCount();
               rowData[5] = getUsers4().get(i).getSummed();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(keys_returned.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new keys_returned().setVisible(true);
            }
        });
    ...
    private javax.swing.JTable jtbl_keys_returned;
